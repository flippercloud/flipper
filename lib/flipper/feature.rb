...
module Flipper
  class Feature
    # @internal The name of feature instrumentation events.
    InstrumentationName = "feature_operation.#{InstrumentationNamespace}".freeze

    # @return [String, Symbol] The name of the feature.
    attr_reader :name

    # @return [String] Name converted to value safe for adapter.
    attr_reader :key

    # @internal The adapter this feature should use.
    attr_reader :adapter
    ...
    #
    # @param name [Symbol,String] name of the feature.
    # @param adapter [Adapter] The adapter that will be used to store details about this feature.
    # @option options [#instrument] :instrumenter - What to use to instrument all the things.
    # @internal
    ...
    # Enable this feature for something.
    #
    # @return the result of {Adapter#enable}
    ...
    # Disable this feature for something.
    #
    # @return the result of {Adapter#disable}
    ...
    # Adds this feature.
    #
    # @return the result of {Adapter#add}
    def add
      instrument(:add) { adapter.add(self) }
    end

    # Does this feature exist in the adapter.
    #
    # @return [Boolean] true if exists in adapter else false.
    def exist?
    ...
    #
    # @return the result of {Adapter#remove}
    def remove
      instrument(:remove) { adapter.remove(self) }
    end

    # Clears all gate values for this feature.
    #
    # @return the result of {Adapter#clear}
    def clear
      instrument(:clear) { adapter.clear(self) }
    end

    # Check if a feature is enabled for zero or more actors.
    #
    ...
    # Enables a feature for an actor.
    #
    # @param actor [Types::Actor, #flipper_id]
    # @return the result of {#enable}
    ...
    # Enables a feature a percentage of time.
    #
    ...
    # Enables a feature for a percentage of actors.
    #
    # percentage - a Flipper::Types::PercentageOfTime instance or an object that
    #              responds to to_i.
    #
    ...
    # Disables a feature for an actor.
    #
    ...
    # Disables a feature a percentage of time.
    #
    # percentage - a Flipper::Types::PercentageOfTime instance or an object that
    #              responds to to_i.
    #
    ...
    # Disables a feature for a percentage of actors.
    #
    # percentage - a Flipper::Types::PercentageOfTime instance or an object that
    #              responds to to_i.
    #
    ...
    # Returns state for feature (:on, :off, or :conditional).
    def state
      values = gate_values
    ...
    # Is the feature fully enabled.
    def on?
      state == :on
    end

    # Is the feature fully disabled.
    def off?
      state == :off
    end

    # Is the feature conditionally enabled for a given actor, group,
    # percentage of actors or percentage of the time.
    def conditional?
      state == :conditional
    end

    # Returns the raw gate values stored by the adapter.
    def gate_values
      adapter_values = adapter.get(self)
      GateValues.new(adapter_values)
    end

    # Get groups enabled for this feature.
    #
    ...
    # Get groups not enabled for this feature.
    #
    # Returns Set of Flipper::Types::Group instances.
    def disabled_groups
    ...
    # Get the adapter value for the groups gate.
    #
    ...
    # Get the adapter value for the actors gate.
    #
    ...
    # Get the adapter value for the boolean gate.
    #
    ...
    # Get the adapter value for the percentage of actors gate.
    #
    ...
    # Get the adapter value for the percentage of time gate.
    #
    # Returns Integer greater than or equal to 0 and less than or equal to 100.
    ...
    # Get the gates that have been enabled for the feature.
    #
    ...
    # Get the names of the enabled gates.
    #
    ...
    # Get the gates that have not been enabled for the feature.
    #
    # Returns an Array of Flipper::Gate instances.
    def disabled_gates
      gates - enabled_gates
    ...
    # Get the names of the disabled gates.
    #
    # Returns an Array of gate names.
    ...
    # Identifier to be used in the url (a rails-ism).
    def to_param
      to_s
    end

    # Pretty string version for debugging.
    def inspect
      attributes = [
        "name=#{name.inspect}",
        "state=#{state.inspect}",
    ...
    # Get all the gates used to determine enabled/disabled for the feature.
    #
    ...
    # Find the gate that protects an actor.
    #
    ...
    # @internal Instrument a feature operation.
