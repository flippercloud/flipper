...
module Flipper
  module Adapters
    class Poll
      ...
      def_delegators :synced_adapter, :features, :get, :get_multi, :get_all, :get_all_snapshot, :supports?, :add, :remove, :clear, :enable, :disable, :read_integer, :set_integer_if_greater
