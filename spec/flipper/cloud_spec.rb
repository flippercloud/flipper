...
RSpec.describe Flipper::Cloud do
  ...
  it 'can import' do
    ...
    get_all = {
      "logging" => {actors: Set.new, boolean: nil, groups: Set.new, expression: nil, percentage_of_actors: nil, percentage_of_time: "5", deny_actors: Set.new, deny_groups: Set.new},
      "search" => {actors: Set.new, boolean: "true", groups: Set.new, expression: nil, percentage_of_actors: nil, percentage_of_time: nil, deny_actors: Set.new, deny_groups: Set.new},
      "stats" => {actors: Set["jnunemaker"], boolean: nil, groups: Set.new, expression: nil, percentage_of_actors: nil, percentage_of_time: nil, deny_actors: Set.new, deny_groups: Set.new},
      "test" => {actors: Set.new, boolean: "true", groups: Set.new, expression: nil, percentage_of_actors: nil, percentage_of_time: nil, deny_actors: Set.new, deny_groups: Set.new},
    }
